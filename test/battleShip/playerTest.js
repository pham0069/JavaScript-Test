...
describe('PLAYER METHODS', function () {
  describe('validateLocation', function () {
    var validateLocation = require('../../src/battleShip/playerMethods.js').validateLocation;
    var player;
  ...
  describe('validateLocations', function () {
    var validateLocations = require('../../src/battleShip/playerMethods.js').validateLocations;
    var player;
  ...
  describe('placeShip', function () {
    var placeShip = require('../../src/battleShip/playerMethods.js').placeShip;
    var player;
